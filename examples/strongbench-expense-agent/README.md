...
The agent helps employees work out what they can reimburse under StrongBench's expense policy. It is the same system every later level builds on — evaluated in Level 2, diagnosed in Level 3, mined for training data in Level 4.
...
| 6 | Agent operating inside StrongBench Corp Simulator | spec only |
