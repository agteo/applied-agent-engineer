...
Written by [`strongbench_agent/trace.py`](../strongbench_agent/trace.py). Checked by `python -m strongbench_agent.check_traces`.
...
| `agent_version` | string | e.g. `strongbench-expense-agent-v1`. |
