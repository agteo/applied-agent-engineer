"""Tool schemas and the final-answer contract for StrongBench Expense Agent v1.
...
SEARCH_POLICY_SCHEMA: dict[str, Any] = {
    "name": "search_policy",
    "description": (
        "Search the StrongBench expense policy corpus and return the most relevant "
...
CALCULATE_REIMBURSEMENT_SCHEMA: dict[str, Any] = {
    ...
    "description": (
        "Apply the StrongBench expense rules to a list of items and return the "
