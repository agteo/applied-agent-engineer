#!/usr/bin/env python3
"""Run the StrongBench Expense Agent.
...
from strongbench_agent.agent import DEFAULT_MAX_STEPS, run_agent
from strongbench_agent.models import get_model
from strongbench_agent.trace import TraceWriter


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run the StrongBench Expense Agent.")
