...
The schemas live in strongbench_agent/schemas.py and the validator in
strongbench_agent/validation.py — read those two files alongside this script.
"""
...
from strongbench_agent.agent import execute_tool, run_agent
from strongbench_agent.models import ModelResponse, ToolCall
from strongbench_agent.schemas import TOOL_SCHEMAS
from strongbench_agent.tools import TOOL_FUNCTIONS
