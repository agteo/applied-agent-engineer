"""Build StrongBench Agent Training Dataset v1.
...
DEFAULT_OUT = ROOT / "datasets" / "strongbench"
LEVEL1_TRACES = ROOT / "examples" / "strongbench-expense-agent" / "traces" / "level-1.jsonl"
FAILURE_ANNOTATIONS = ROOT / "evals" / "operations" / "strongbench" / "annotated-failures.jsonl"


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build StrongBench Agent Training Dataset v1.")
    ...
    for index in range(1, 101):
        ...
        rows.append(
            make_example(
                ...
                provenance={
                    "generator": "datasets.strongbench.synthetic_examples",
...
def dirty_examples(existing_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    invalid_target = make_example(
        ...
        labels=["cleaning_fixture"],
        provenance={"generator": "datasets.strongbench.dirty_examples"},
    )
...
def render_dataset_card(metrics: dict[str, Any]) -> str:
    return (
        "# StrongBench Agent Training Dataset v1\n\n"
        "## Intended Use\n\n"
        "Use this dataset to prototype supervised correction, preference, and regression-data workflows for the StrongBench Expense Agent. It is a teaching dataset, not production financial data.\n\n"
        "## Sources\n\n"
        ...
        "## Schema\n\n"
        "Rows follow `datasets/strongbench/schema.json` and include `example_id`, `source_type`, `messages`, `target_final_answer`, labels, provenance, quality flags, and split.\n\n"
        "## Cleaning\n\n"
        ...
        "## Privacy\n\n"
        "All examples use fictional StrongBench fixtures. No personal, customer, or production data is included.\n\n"
        "## Level 5 Use Case\n\n"
...
Synthetic examples are generated by `datasets.strongbench.synthetic_examples`.
