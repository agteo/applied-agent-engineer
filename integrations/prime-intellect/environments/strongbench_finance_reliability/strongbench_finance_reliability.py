"""Prime Intellect / Verifiers adapter over the local StrongBench Finance simulator.
...
from environments.strongbench_finance import (  # noqa: E402
...
ENVIRONMENT_ID = "strongbench_finance_reliability"
...
class StrongBenchFinanceReliabilityEnv:
...
def load_environment(seed: int = 42, task_count: int = 120) -> StrongBenchFinanceReliabilityEnv:
    """Dependency-free entry point. This is what CI exercises."""
    return StrongBenchFinanceReliabilityEnv(seed=seed, task_count=task_count)
