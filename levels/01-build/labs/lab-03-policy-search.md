...
Write your own version first, then compare: [`solutions/lab_03_policy_search.py`](../../../examples/strongbench-expense-agent/solutions/lab_03_policy_search.py).
...
The corpus is `fixtures/policies.json`. Write your own limitations list before reading the one it prints. [How to compare](../../../examples/strongbench-expense-agent/solutions/README.md).
