...
AGENT_ROOT = Path(__file__).resolve().parents[3] / "examples" / "acme-expense-agent"
if str(AGENT_ROOT) not in sys.path:
    sys.path.insert(0, str(AGENT_ROOT))

from acme_agent.schemas import FINAL_ANSWER_SCHEMA  # noqa: E402
from acme_agent.validation import ValidationError, validate  # noqa: E402
