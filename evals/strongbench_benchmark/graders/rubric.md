# StrongBench Benchmark Rubric

Use this rubric for answer quality after deterministic checks pass.
...
- Omits the main answer, fabricates policy basis, skips required approval, or says the agent can submit on the employee's behalf.
